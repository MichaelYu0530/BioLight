...
def main():
    ...
    img1 = initialize_img(height, width)
    
    rect_point_list = [(80, 80), (350, 175)] # 条带参数，矩形左上、右下顶点
    
    # 绘制原图，只含一个矩形条带
    center = build_regular_bands(img1, [rect_point_list[0]], [rect_point_list[1]], is_few_bands=True)
    ...
    img2 = initialize_img(height, width)
    ...
    # 构造3个泳道内共14个矩形条带
    center_list = build_regular_bands(img2, rect_band_corner1_list, rect_band_corner2_list, is_few_bands=False)
